...
export class Contract {
  ...
  update_allowanceTx(
    ...
    return transactions.functionCall(
      ...
      options?.attachedDeposit ?? NEAR.from(0)
    )
  }
  ...
  total_cost(
    args: { num: number; minter: AccountId },
    options?: ViewFunctionOptions
  ): Promise<U128> {
    return this.account.viewFunction(
      this.contractId,
  ...
  async start_premint(
    ...
    return providers.getTransactionLastResult(
      await this.start_premintRaw(args, options)
    )
  }
  start_premintRaw(
    args: { duration: bigint },
  ...
  nft_payout(
    args: { token_id: string; balance: U128; max_len_payout?: number },
    options?: ViewFunctionOptions
  ): Promise<Payout> {
    return this.account.viewFunction(
      this.contractId,
  ...
  async end_premint(
    args: { base_cost: U128; min_cost: U128; percent_off?: number },
    options?: ChangeMethodOptions
  ): Promise<void> {
    return providers.getTransactionLastResult(
      await this.end_premintRaw(args, options)
    )
  }
  end_premintRaw(
    args: { base_cost: U128; min_cost: U128; percent_off?: number },
  ...
  add_whitelist_account_ungaurdedRaw(
    ...
    return this.account.functionCall({
      contractId: this.contractId,
      methodName: "add_whitelist_account_ungaurded",
      args,
      ...options,
    })
  }
